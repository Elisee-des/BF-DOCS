...
const HomePage = () => {
    return (
                                ...
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="client-images">
                                            <img src="assets/images/clients/amazon.svg" alt="client-img" className="mx-auto img-fluid d-block"/>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="client-images">
                                            <img src="assets/images/clients/walmart.svg" alt="client-img" className="mx-auto img-fluid d-block"/>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="client-images">
                                            <img src="assets/images/clients/lenovo.svg" alt="client-img" className="mx-auto img-fluid d-block"/>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="client-images">
                                            <img src="assets/images/clients/paypal.svg" alt="client-img" className="mx-auto img-fluid d-block"/>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="client-images">
                                            <img src="assets/images/clients/shopify.svg" alt="client-img" className="mx-auto img-fluid d-block"/>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="client-images">
                                            <img src="assets/images/clients/verizon.svg" alt="client-img" className="mx-auto img-fluid d-block"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <button className="btn btn-danger btn-icon landing-back-top" id="back-to-top">
